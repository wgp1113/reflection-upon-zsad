...
def test(args):
    ...
    text = "Time for testing mvtec: {}s ,total image num:{}\n".format(end_time - start_time, total_num)
    with open('/home/dell/wgp3/AnomalyCLIP/mvtec_inference_time.txt', 'a', encoding='utf-8') as f:
        f.write(text)
