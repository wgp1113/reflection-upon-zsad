...
for i in {1..15};do
  ...
  --save_path ./results/visa_zsad_common_sense/9_12_4_multiscale/zero_shot_${i} \
...
python test.py --dataset visa \
--data_path  /home/dell/wgp/datasets/zsad_datasets/VisA_zsad_common_sense \
--save_path ./results/visa_zsad_common_sense_seed_111/9_12_4_multiscale/zero_shot_15 \
