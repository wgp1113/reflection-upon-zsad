...
#CMD_TO_RUN="python bin/run_scad.py --gpu 1 --seed 0 --save_patchcore_model --log_group SCAD_IM256-224_WR50_L2-3_P0_D1024-1024_PS3_AN0_S0 --log_project mvtec_UAD_partial_gpu_memory results scad -b wideresnet50 -le layer2 -le layer3 --pretrain_embed_dimension 1024 --target_embed_dimension 1024 --anomaly_scorer_num_nn 0 --patchsize 3 sampler -p 0.0 --filter online_ada_agc dataset --resize [256,256] --imagesize [224,224] --train_mode partial -d bottle -d cable -d capsule -d carpet -d grid -d hazelnut -d leather -d  metal_nut -d  pill -d  screw -d tile -d toothbrush -d transistor -d wood -d zipper mvtec ./data/mvtec"

#CMD_TO_RUN="python train.py --dataset mvtec --train_data_path /home/dell/wgp/datasets/mvtec_ad/mvtec_anomaly_detection --save_path ./checkpoints/mvtec_seed_0_gpu_memory --features_list 24 --image_size 518 --batch_size 8 --print_freq 1 --epoch 15 --save_freq 1 --seed 0 --depth 9 --n_ctx 12 --t_n_ctx 4"
#CMD_TO_RUN="python train.py --dataset visa --train_data_path /home/dell/wgp/datasets/VisA --save_path ./checkpoints/visa_seed_0_gpu_memory --features_list 24 --image_size 518  --batch_size 8 --print_freq 1 --epoch 15 --save_freq 1 --seed 0 --depth 9 --n_ctx 12 --t_n_ctx 4"
#CMD_TO_RUN="python test.py --dataset visa --data_path  /home/dell/wgp/datasets/VisA --save_path ./results/test_time_visa_origin_seed_111/9_12_4_multiscale/zero_shot_15 --checkpoint_path ./checkpoints/mvtec_origin_seed_111/epoch_15.pth --features_list 24 --image_size 518 --depth 9 --n_ctx 12 --t_n_ctx 4"

CMD_TO_RUN="python test.py --dataset mvtec --data_path  /home/dell/wgp/datasets/mvtec_ad/mvtec_anomaly_detection --save_path ./results/test_time_mvtec_origin_seed_111/9_12_4_multiscale/zero_shot_15 --checkpoint_path ./checkpoints/visa_origin_seed_111/epoch_15.pth --features_list 24 --image_size 518 --depth 9 --n_ctx 12 --t_n_ctx 4"
...
nohup $CMD_TO_RUN > test_mvtec_output.log 2>&1 &
CMD_PID=$!
...
# 可以选择将结果保存到文件
echo "程序最大显存增量: ${MEM_INCREASE} MiB" > test_mvtec_gpu_increase_result.txt
echo "详细结果已保存到 test_mvtec_gpu_increase_result.txt"