...
export CUDA_VISIBLE_DEVICES=1
python train.py --dataset mvtec --train_data_path /home/dell/wgp/datasets/mvtec_ad/mvtec_anomaly_detection --save_path ./checkpoints/mvtec_seed_0_gpu_memory --features_list 24 --image_size 518 --batch_size 8 --print_freq 1 --epoch 15 --save_freq 1 --seed 0 --depth 9 --n_ctx 12 --t_n_ctx 4
...
python train.py --dataset visa --train_data_path /home/dell/wgp/datasets/VisA --save_path ./checkpoints/visa_seed_0_gpu_memory --features_list 24 --image_size 518  --batch_size 8 --print_freq 1 --epoch 15 --save_freq 1 --seed 0 --depth 9 --n_ctx 12 --t_n_ctx 4
...
----------------------------------------------------------------------------------------------------------
/home/dell/wgp/datasets/rethink_zsad_datasets/mvtec_anomaly_detection

export CUDA_VISIBLE_DEVICES=0
python train.py --dataset mvtec \
--train_data_path /home/dell/wgp/datasets/rethink_zsad_datasets/mvtec_anomaly_detection \
--save_path ./checkpoints/mvtec_rethink_zsad_seed_111 --features_list 24 --image_size 518  \
--batch_size 8 --print_freq 1 --epoch 15 --save_freq 1 --seed 111 \
--depth 9 --n_ctx 12 --t_n_ctx 4
...
--save_path ./checkpoints/visa_rethink_zsad_seed_111 --features_list 24 --image_size 518  \
--batch_size 8 --print_freq 1 --epoch 15 --save_freq 1 --seed 111 \
--depth 9 --n_ctx 12 --t_n_ctx 4
...
python train.py --dataset mvtec \
--train_data_path /home/dell/wgp/datasets/rethink_zsad_datasets/mvtec_anomaly_detection \
--save_path ./checkpoints/mvtec_rethink_zsad_seed_42 --features_list 24 --image_size 518  \
--batch_size 8 --print_freq 1 --epoch 15 --save_freq 1 --seed 42 \
--depth 9 --n_ctx 12 --t_n_ctx 4
...
python train.py --dataset visa \
--train_data_path /home/dell/wgp/datasets/rethink_zsad_datasets/visa \
--save_path ./checkpoints/visa_rethink_zsad_seed_42 --features_list 24 --image_size 518  \
--batch_size 8 --print_freq 1 --epoch 15 --save_freq 1 --seed 42 \
--depth 9 --n_ctx 12 --t_n_ctx 4
...
python train.py --dataset mvtec \
--train_data_path /home/dell/wgp/datasets/rethink_zsad_datasets/mvtec_anomaly_detection \
--save_path ./checkpoints/mvtec_rethink_zsad_seed_0 --features_list 24 --image_size 518  \
--batch_size 8 --print_freq 1 --epoch 15 --save_freq 1 --seed 0 \
--depth 9 --n_ctx 12 --t_n_ctx 4
...
python train.py --dataset visa \
--train_data_path /home/dell/wgp/datasets/rethink_zsad_datasets/visa \
--save_path ./checkpoints/visa_rethink_zsad_seed_0 --features_list 24 --image_size 518  \
--batch_size 8 --print_freq 1 --epoch 15 --save_freq 1 --seed 0 \
--depth 9 --n_ctx 12 --t_n_ctx 4
...
--save_path ./checkpoints/mvtec_origin_12_seed_0 --features_list 24 --image_size 518  \
--batch_size 8 --print_freq 1 --epoch 15 --save_freq 1 --seed 0 \
--depth 9 --n_ctx 12 --t_n_ctx 4
