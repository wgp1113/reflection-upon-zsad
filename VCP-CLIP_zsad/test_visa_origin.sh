...
--checkpoint_path ./my_exps/train_mvtec_origin/epoch_${i}_group_id_2.pth \
--save_path ./results/visa_origin_${i} --pretrained_path ./pretrained_weight/ViT-L-14-336px.pt \
