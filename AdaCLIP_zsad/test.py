...
def train(args):
    ...
    if args.testing_model == 'dataset':
        ...
        if args.exclude_dataset_name:
            save_root = f'{args.save_path}/{args.training_data}-{args.exclude_dataset_name}'
        else:
            save_root = f'{args.save_path}/origin'
        ...
        #     logger.info(
        #         '{:>15} \t\tP-Auroc:{:.4f} \tP-F1:{:.4f} \tP-AP:{:.4f} \tAupro:{:.4f} \tI-Auroc:{:.4f} \tI-F1:{:.4f} \tI-AP:{:.4f}'.
        #     format(tag,
        #            data['auroc_px'],
        #            data['f1_px'],
        #            data['ap_px'],
