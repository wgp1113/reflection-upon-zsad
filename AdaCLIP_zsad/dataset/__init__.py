...
from .atciad import ATCIAD_CLS_NAMES, ATCiadDataset, ATCIAD_ROOT
from .realiad import REALIAD_CLS_NAMES, RealIADDataset, REALIAD_ROOT
...
from .cvc300 import CVC300_CLS_NAMES,CVC300Dataset,CVC300_ROOT
from .wfdd import WFDD_CLS_NAMES,WFDDDataset,WFDD_ROOT
from .ksdd2 import KSDD2_CLS_NAMES,KSDD2Dataset,KSDD2_ROOT

from torch.utils.data import ConcatDataset

dataset_dict = {
    'br35h': (Br35h_CLS_NAMES, Br35hDataset, Br35h_ROOT),
    'brainmri': (BrainMRI_CLS_NAMES, BrainMRIDataset, BrainMRI_ROOT),
    ...
    'cvc300': (CVC300_CLS_NAMES, CVC300Dataset, CVC300_ROOT),
    ...
    'realiad':(REALIAD_CLS_NAMES, RealIADDataset, REALIAD_ROOT),
    'atciad':(ATCIAD_CLS_NAMES, ATCiadDataset, ATCIAD_ROOT),
    'wfdd':(WFDD_CLS_NAMES, WFDDDataset, WFDD_ROOT),
    'dtd': (DTD_CLS_NAMES, DTDDataset, DTD_ROOT),
    'ksdd2': (KSDD2_CLS_NAMES, KSDD2Dataset, KSDD2_ROOT),
}

def get_data(dataset_type_list, transform, target_transform, training, dataset_name='', exclude_dataset_name=''):
