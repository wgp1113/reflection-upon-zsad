...
# VISA_ROOT = os.path.join(DATA_ROOT, 'zsad_datasets','VisA_zsad_common_sense')
# VISA_ROOT = os.path.join(DATA_ROOT, 'zsad_datasets','VisA_zsad_extended')
VISA_ROOT = os.path.join(DATA_ROOT, 'rethink_zsad_datasets','visa')
