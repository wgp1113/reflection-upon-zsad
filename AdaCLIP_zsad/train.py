...
def train(args):
    ...
    train_data_cls_names, train_data, train_data_root = get_data(
        ...
        training=True, dataset_name=args.training_data[0], exclude_dataset_name=args.exclude_dataset_name)
    ...
    ckp_path_ordered = ckp_path + f'_{0}.pth'
    model.save(ckp_path_ordered)
    ...
    for epoch in tqdm(range(epochs)):
        ...
        if (epoch + 1) % args.valid_freq == 0 or (epoch == epochs - 1):
            ...
            #save model
            ckp_path_ordered = ckp_path + f'_{epoch}.pth'
            model.save(ckp_path_ordered)
    ...
    # with open('/mnt/data1/wgp/AdaCLIP_zsad/visa_training_time.txt', 'a', encoding='utf-8') as f:
    #     f.write(text)
...
if __name__ == '__main__':
    ...
    parser.add_argument("--training_data_path", type=str,  help="training data path")
    parser.add_argument("--testing_data", type=str, default="visa", help="Dataset for testing (default: 'visa')")
    parser.add_argument("--testing_data_path", type=str, help="testing data path")
    ...
    parser.add_argument("--exclude_dataset_name", type=str, default='', help="exclude dataset name (default: '')")
    # Hyper-parameters
