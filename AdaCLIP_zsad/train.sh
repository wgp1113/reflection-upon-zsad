...
python train.py --save_fig True \
--training_data mvtec --epoch 5 --seed 0 \
--save_path ./checkpoints/mvtec_seed_0_gpu_memory \
--testing_data visa
...
python train.py --save_fig True --training_data mvtec --epoch 5 --seed 0 --save_path ./checkpoints/mvtec_seed_0_gpu_memory --testing_data visa

python train.py --save_fig True --training_data visa --epoch 5 --seed 0 --save_path ./checkpoints/visa_seed_0_gpu_memory --testing_data mvtec


--------------------------------------------------------------------------------------------------------
export CUDA_VISIBLE_DEVICES=0
python train.py --save_fig True \
--training_data visa --epoch 5 --seed 111 \
--save_path ./checkpoints/visa_rethink_zsad_seed_111 \
--testing_data mvtec

export CUDA_VISIBLE_DEVICES=1
python train.py --save_fig True \
--training_data mvtec --epoch 5 --seed 111 \
--save_path ./checkpoints/mvtec_rethink_zsad_seed_111 \
--testing_data visa
...
python train.py --save_fig True \
--training_data visa --epoch 5 --seed 42 \
--save_path ./checkpoints/visa_rethink_zsad_seed_42 \
--testing_data mvtec

export CUDA_VISIBLE_DEVICES=3
python train.py --save_fig True \
--training_data mvtec --epoch 5 --seed 42 \
--save_path ./checkpoints/mvtec_rethink_zsad_seed_42 \
--testing_data visa
...
python train.py --save_fig True \
--training_data visa --epoch 5 --seed 0 \
--save_path ./checkpoints/visa_rethink_zsad_seed_0 \
--testing_data mvtec

export CUDA_VISIBLE_DEVICES=1
python train.py --save_fig True \
--training_data mvtec --epoch 5 --seed 0 \
--save_path ./checkpoints/mvtec_rethink_zsad_seed_0 \
--testing_data visa
