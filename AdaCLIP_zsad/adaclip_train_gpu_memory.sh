...
CMD_TO_RUN="python train.py --save_fig True --training_data visa --epoch 5 --seed 0 --save_path ./checkpoints/visa_seed_0_gpu_memory --testing_data mvtec"
...
nohup $CMD_TO_RUN > mvtec_output.log 2>&1 &
CMD_PID=$!
