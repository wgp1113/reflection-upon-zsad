...
#CMD_TO_RUN="python train.py --save_fig True --training_data mvtec --epoch 5 --seed 0 --save_path ./checkpoints/mvtec_seed_0_gpu_memory --testing_data visa"

CMD_TO_RUN="python test.py --testing_model dataset --ckt_path "/mnt/data1/wgp/AdaCLIP_zsad/checkpoints/mvtec_origin/origin/models/[mvtec]_5.pth" --save_fig True --save_path ./workspaces/results/time_test_visa_zsad_common_sense_train_mvtec_origin --testing_data visa"
#CMD_TO_RUN="python test.py --testing_model dataset --ckt_path "/mnt/data1/wgp/AdaCLIP_zsad/checkpoints/visa_origin/origin/models/[visa]_5.pth" --save_fig True --save_path ./workspaces/results/time_test_mvtec_zsad_common_sense_train_mvtec_origin --testing_data mvtec"
...
nohup $CMD_TO_RUN > visa_output.log 2>&1 &
CMD_PID=$!
...
# 可以选择将结果保存到文件
echo "程序最大显存增量: ${MEM_INCREASE} MiB" > visa_gpu_increase_result.txt
echo "详细结果已保存到 visa_gpu_increase_result.txt"