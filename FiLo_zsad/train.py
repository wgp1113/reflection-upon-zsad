...
if __name__ == "__main__":
    ...
    parser.add_argument("--adapter_epoch", type=int, default=1, help="epochs")
    ...
    text = "{} Time for training: {} \n".format(dataset_name, end_time_train - start_time_train)
    print(text)
    with open('/home/dell/wgp/FiLo/{}_training_time.txt'.format(dataset_name), 'a', encoding='utf-8') as f:
        f.write(text)