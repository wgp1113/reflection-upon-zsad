...
-----------------------------------------------------------------------------------------------------------------------
export CUDA_VISIBLE_DEVICES=0
python train.py --save_path ./checkpoints/SDP_plus/train_on_mvtec_rethink_zsad_seed_111 \
--train_dataset mvtec --train_dataset_dir /home/dell/wgp/datasets/rethink_zsad_datasets/mvtec_anomaly_detection \
--test_dataset visa --test_dataset_dir /home/dell/wgp/datasets/rethink_zsad_datasets/visa \
--model ViT-B-16-plus-240 --pretrained laion400m_e31 --config_path ./open_clip/model_configs/ViT-B-16-plus-240.json \
--img_size 240 --batch_size 8 --features_list 3 6 9 12 --rep_vec dbscan \
--print_freq 1 --save_freq 1 --epochs 5 --learning_rate 0.0001 --seed 111
...
export CUDA_VISIBLE_DEVICES=1
python train.py --save_path ./checkpoints/SDP_plus/train_on_visa_rethink_zsad_seed_111 \
--train_dataset visa --train_dataset_dir /home/dell/wgp/datasets/rethink_zsad_datasets/visa \
--test_dataset mvtec --test_dataset_dir /home/dell/wgp/datasets/rethink_zsad_datasets/mvtec_anomaly_detection \
--model ViT-B-16-plus-240 --pretrained laion400m_e31 --config_path ./open_clip/model_configs/ViT-B-16-plus-240.json \
--img_size 240 --batch_size 8 --features_list 3 6 9 12 --rep_vec dbscan \
--print_freq 1 --save_freq 1 --epochs 5 --learning_rate 0.0001 --seed 111
...
export CUDA_VISIBLE_DEVICES=0
python train.py --save_path ./checkpoints/SDP_plus/train_on_mvtec_rethink_zsad_seed_42 \
--train_dataset mvtec --train_dataset_dir /home/dell/wgp/datasets/rethink_zsad_datasets/mvtec_anomaly_detection \
--test_dataset visa --test_dataset_dir /home/dell/wgp/datasets/rethink_zsad_datasets/visa \
--model ViT-B-16-plus-240 --pretrained laion400m_e31 --config_path ./open_clip/model_configs/ViT-B-16-plus-240.json \
--img_size 240 --batch_size 8 --features_list 3 6 9 12 --rep_vec dbscan \
...
export CUDA_VISIBLE_DEVICES=1
python train.py --save_path ./checkpoints/SDP_plus/train_on_visa_rethink_zsad_seed_42 \
--train_dataset visa --train_dataset_dir /home/dell/wgp/datasets/rethink_zsad_datasets/visa \
--test_dataset mvtec --test_dataset_dir /home/dell/wgp/datasets/rethink_zsad_datasets/mvtec_anomaly_detection \
--model ViT-B-16-plus-240 --pretrained laion400m_e31 --config_path ./open_clip/model_configs/ViT-B-16-plus-240.json \
--img_size 240 --batch_size 8 --features_list 3 6 9 12 --rep_vec dbscan \
...
export CUDA_VISIBLE_DEVICES=2
python train.py --save_path ./checkpoints/SDP_plus/train_on_mvtec_rethink_zsad_seed_0 \
--train_dataset mvtec --train_dataset_dir /home/dell/wgp/datasets/rethink_zsad_datasets/mvtec_anomaly_detection \
--test_dataset visa --test_dataset_dir /home/dell/wgp/datasets/rethink_zsad_datasets/visa \
--model ViT-B-16-plus-240 --pretrained laion400m_e31 --config_path ./open_clip/model_configs/ViT-B-16-plus-240.json \
--img_size 240 --batch_size 8 --features_list 3 6 9 12 --rep_vec dbscan \
...
export CUDA_VISIBLE_DEVICES=3
python train.py --save_path ./checkpoints/SDP_plus/train_on_visa_rethink_zsad_seed_0 \
--train_dataset visa --train_dataset_dir /home/dell/wgp/datasets/rethink_zsad_datasets/visa \
--test_dataset mvtec --test_dataset_dir /home/dell/wgp/datasets/rethink_zsad_datasets/mvtec_anomaly_detection \
--model ViT-B-16-plus-240 --pretrained laion400m_e31 --config_path ./open_clip/model_configs/ViT-B-16-plus-240.json \
--img_size 240 --batch_size 8 --features_list 3 6 9 12 --rep_vec dbscan \
