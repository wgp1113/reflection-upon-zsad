...
def generate_class_info(dataset_name):
    ...
    #     obj_list = ['carpet','grid','leather','tile','wood','bottle','capsule','pill','transistor','zipper',
    #                 'cable','hazelnut','metal_nut','screw','toothbrush']
    # elif dataset_name == 'visa':
    #     obj_list = ['candle', 'capsules', 'cashew', 'chewinggum', 'fryum', 'macaroni1', 'macaroni2',
    #                 'pcb1', 'pcb2', 'pcb3', 'pcb4', 'pipe_fryum']
    if dataset_name == 'mvtec':
        obj_list = ['carpet','grid','leather','tile','wood','capsule','transistor','zipper',
                    'cable','hazelnut','screw','toothbrush']
    elif dataset_name == 'visa':
        obj_list = ['candle', 'capsules', 'cashew', 'chewinggum', 'fryum', 'macaroni1', 'macaroni2',
        ...
        obj_list = ['thyroid']
    elif dataset_name == 'headct2':
        obj_list = ['headct2']
    elif dataset_name == 'brainmri2':
        obj_list = ['brainmri2']
    elif dataset_name == 'LAG':
        obj_list = ['LAG']
    elif dataset_name == 'br35':
        obj_list = ['br35']
    elif dataset_name == 'Brain_MRI':
        obj_list = ['Brain_MRI']
    elif dataset_name == 'elpv':
        obj_list = ['elpv']
    elif dataset_name == 'AITEX':
        obj_list = ['AITEX']
    elif dataset_name == 'test':
        obj_list = ['bend_and_parts_mismatch', 'defective_painting', 'hole', 'rust', 'scratches']
    elif dataset_name == 'test2':
        obj_list = ["Broken_end", "Broken_yarn", "Crease", "Fuzzyball", "Nep", "Weft_crack",
                    "Broken_pick", "Contamination", "Cut_selvage", "Knots", "Warp_ball", "Weft_curling"]
