...
--save_path ./results/winclip_mvtec_rethink_zsad/few-shot-0 \
--model ViT-B-16-plus-240 --pretrained openai \
--save_image True \
--k_shot 0 --image_size 240
...
--save_path ./results/winclip_visa_rethink_zsad/few-shot-0 \
--model ViT-B-16-plus-240 --pretrained openai \
--save_image True \
--k_shot 0 --image_size 240
...
############################### ksdd2 wfdd dtd ##################################################################
export CUDA_VISIBLE_DEVICES=0
python reproduce_WinCLIP_back.py --dataset wfdd \
--data_path /home/dell/wgp/datasets/WFDD \
--save_path ./results/winclip_wfdd/few-shot-0 \
--model ViT-B-16-plus-240 --pretrained openai \
--save_image True \
--k_shot 0 --image_size 240

export CUDA_VISIBLE_DEVICES=1
python reproduce_WinCLIP_back.py --dataset dtd \
--data_path /home/dell/wgp/datasets/DTD-Synthetic \
--save_path ./results/winclip_dtd/few-shot-0 \
--model ViT-B-16-plus-240 --pretrained openai \
--save_image True \
--k_shot 0 --image_size 240

export CUDA_VISIBLE_DEVICES=2
python reproduce_WinCLIP_back.py --dataset ksdd2 \
--data_path /home/dell/wgp/datasets/ksdd2 \
--save_path ./results/winclip_ksdd2/few-shot-0 \
--model ViT-B-16-plus-240 --pretrained openai \
--save_image True \
--k_shot 0 --image_size 240
